...
function renderScenarioIntro() {
  ...
  app.innerHTML = `
    <div class="card">
      ...
      <p><strong>Вызов для маркетолога:</strong> Вам предстоит оптимизировать распределение бюджета в условиях ограниченных ресурсов и конкурентной среды. Учитывайте особенности бизнеса и специфику каждого канала.</p>
